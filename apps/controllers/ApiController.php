...
class ApiController extends \ControllerBase {
    public function getAction(){
        ...
        if (!empty($newsdata)){
            ...
            if ($newsdata->save()){
                $this->ssussess($newsdata->tid.'|'.$newsdata->orderid);
            }else{
                $this->serror('数据保存失败');
            }
